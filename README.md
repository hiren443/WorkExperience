...
### Skills
<b>Programming Languages (Experience in years):</b> Swift (>8), Objective-C (9), Angular.js(6 months), node.js(6 months), HTML/CSS(6 months)

<b>iOS Frameworks:</b> Foundation, UIKit, CoreLocation, MapKit, CoreData, AVFoundation, WebKit and Realm, CoreData, SwiftyJSON, AFNetworking, XCTest, Observables, Closures, Google Analytics, FireBase, SwiftLint, SonarQube, Visa Checkout, Speech-to-text (local and remote), Chatbot integrations, ZBar SDk
